...
Most of these come down to network reality or how theaudiodb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

theaudiodb rate-limits like any public site. theaudiodb already paces
...
Where a surface is gated, theaudiodb reads a cookie or token you supply
...
`theaudiodb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what theaudiodb actually did
